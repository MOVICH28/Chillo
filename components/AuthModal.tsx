        ...
        {(view === "login" || view === "register") && (
          <>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-lg bg-white hover:bg-gray-50 border border-gray-300 text-gray-700 text-sm font-semibold transition-colors mb-4"
            >
